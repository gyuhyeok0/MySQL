...
(2,'user02', 'pass02', '심청', '여', '010-1234-5678', 'hong123@gmail.com');

select * from user_notnull;

-- not null로 설정한 user_pwd null 값을 넣어보

insert into user_notnull
(user_no, user_id, user_pwd, user_name, gender, phone, email)
values
(1,'user01', null, '심청', '여', '010-1234-5678', 'hong123@gmail.com');
...
create table if not exists user_unique (
   user_no int not null unique,  -- << 요기는 not null 값이 비면 안되면서 , 중복도 안됀다는 의미
    user_id varchar(255) not null,
    user_pwd varchar(255) not null,
    user_name varchar(255) not null,
    gender varchar(3), 
...
(2,'user02','pass02', '유관순', '남', '010-1234-5671' , 'hong@gmail.com');
...
-- 한 개 컬럼에 설정할 수도 있지만 여러개를 묶어서 사용할 수 도 있다.(복합키)
...
(user_no, user_id , user_pwd , user_name, gender, phone, email)
values
( 3 ,'user01','pass01', '홍길동', '남', '010-1234-5678' , 'hong@gmail.com');
...
create table if not exists user_foreignkey1 (
    ...
    email varchar(255),
    grade_code int,
    foreign key(grade_code) -- 외례키
    references user_grade(grade_code) -- 참조관계
...
(2,'user02','pass02', '유관순', '남', '010-1234-5671' , 'hong@gmail.com', 20),
(3,'user03','pass03', '홍길동2', '남', '010-1334-5678' , 'hong@gmail.com', 10),
(4,'user04','pass04', '유관순2', '남', '010-1334-5671' , 'hong@gmail.com', 20);
...
(user_no, user_id , user_pwd , user_name, gender, phone, email, grade_code)
values
(5,'user05','pass05', '유관순3', '남', '010-1334-5671' , 'hong@gmail.com', 30);
...
-- defalult 설정이 되어 있는 컬럼들에 default 값이 들어갈 수 있도록 한다.
