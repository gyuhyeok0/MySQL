...
-- tbl_menu 테입블에서 메뉴 이름, 가격, 판매상태를 조회할건데 메뉴 가격이 13000원 인 친구들만 조회해줘    
select    
   menu_name,
    menu_price,
    orderable_status
...
from
   tbl_category
where
   ref_category_code is not null; -- not 도 사용가능 (null 이 아닌 놈들불러와 라는 의미)
